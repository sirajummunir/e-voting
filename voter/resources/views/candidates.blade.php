...
<div class="row">
	<div class="col s12">
		<a class="teal btn modal-trigger right" href="#addModal"><i class="material-icons left">add</i> Add Candidate</a>
	</div>
...
<div class="modal" id="addModal" style="padding: 2em;">
	<div class="modal-content">
		...
		<form method="post" action="{{ route('candidate.store') }}">
			...
			<div class="col s12">
				<button class="teal hoverable btn">Add Candidate</button>
			</div>
		</form>
	</div>
