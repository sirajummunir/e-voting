    ...
    <div class="row">
        <div class="card-panel col m12 row hoverable" style="margin-top: 50px; padding: 20px;">
            ...
            <form method="post" action="{{ route('register') }}">
                ...
                <div class="input-field col m6">
                    <input name="nid" id="nid" type="text" value="{{ old('nid') }}" data-length=14>
                ...
                <div class="input-field col m6">
                    <input name="religion" id="religion" type="text" value="{{ old('religion') }}">
                ...
                <div class="input-field col m6">
                    <input name="marital" id="marital" type="text" value="{{ old('marital') }}">
                    <label for="name">Marital</label>
                ...
                <div class="input-field col m6">
                    <input name="gender" id="gender" type="text" value="{{ old('gender') }}">
                ...
                <div class="input-field col m6">
                    <input name="mobile" id="mobile" type="text" value="{{ old('mobile') }}">
